...
export default function Dashboard(){return <AuthGuard allowedRoles={["admin","stock","accounts"]}><div className={styles.page}><div className={styles.shell}><Sidebar/><main className={styles.main}>
