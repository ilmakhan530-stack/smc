  ...
  return <AuthGuard allowedRoles={["admin"]}>
    <div className="bill-app" style={{display:"flex",minHeight:"100vh"}}>
      ...
      <style jsx global>{`
        ...
        .invoice-wrap{width:min(100%,210mm);max-width:210mm;margin:30px auto}.invoice{background:#fff;color:#111;border:1px solid #222;padding:10mm;min-height:297mm;height:297mm;box-sizing:border-box;font-family:Arial,sans-serif;font-size:10px;line-height:1.35;box-shadow:0 5px 20px #0001;display:flex;flex-direction:column}.invoice-top{display:flex;justify-content:space-between;border-bottom:1px solid #222;padding-bottom:8px}.invoice-title{text-align:center;font-size:18px;font-weight:800}.small{font-size:8px;letter-spacing:1px}.invoice-meta{display:grid;grid-template-columns:1.3fr 1.3fr 1fr;border-bottom:1px solid #222}.invoice-meta>div{padding:8px;border-right:1px solid #222;min-height:95px}.invoice-meta>div:last-child{border-right:0}.party-name{font-size:12px;font-weight:800;margin:2px 0}.invoice-table{width:100%;border-collapse:collapse}.invoice-table th,.invoice-table td{border:1px solid #222;padding:6px;vertical-align:top}.invoice-table th{font-size:9px}.invoice-table td:nth-child(1){width:35px;text-align:center}.invoice-table td:nth-child(3){width:70px}.invoice-table td:nth-child(4){width:85px}.invoice-table td:nth-child(5),.invoice-table td:nth-child(6){width:85px;text-align:right}.invoice-table tbody tr:first-child td{height:82mm}.tax-inline{text-align:center;font-weight:700;margin-top:24px}.words{border:1px solid #222;border-top:0;padding:8px;min-height:42px}.tax-summary{border:1px solid #222;border-top:0;padding:7px}.tax-summary table{width:100%;border-collapse:collapse;margin-top:5px}.tax-summary th,.tax-summary td{border:1px solid #222;padding:4px;text-align:right}.invoice-bottom{display:grid;grid-template-columns:1.6fr 1fr;border:1px solid #222;border-top:0;min-height:120px;flex:1}.invoice-bottom>div{padding:8px}.signature{border-left:1px solid #222;text-align:right;padding-top:65px!important}.generated{text-align:center;padding-top:7px;font-size:8px}.copy-label{text-align:right;font-size:8px;font-weight:700;margin-bottom:5px}.copy-break{display:block;height:14mm}
        @media print{html,body{background:#fff!important;margin:0!important;padding:0!important}.no-print{display:none!important}.bill-app{display:block!important;min-height:0!important}.bill-app main{padding:0!important}.invoice-wrap{width:210mm!important;max-width:210mm!important;margin:0!important}.invoice{width:210mm!important;height:297mm!important;min-height:297mm!important;margin:0!important;padding:10mm!important;box-shadow:none!important;border:1px solid #222;box-sizing:border-box;break-inside:avoid;page-break-after:auto}.invoice-table{page-break-inside:auto}.invoice-table tr{page-break-inside:avoid}.invoice-bottom{page-break-inside:avoid}.copy-break{page-break-before:always;height:0!important}@page{size:A4 portrait;margin:0}}
      `}</style>
    </div>
  </AuthGuard>
}
